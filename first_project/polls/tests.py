...
class QuestionViewTest(TestCase):
    ...
    def test_past_question(self):
        """
        Вопросы с датой публикации раньше текущего дня отображается на странице.
        """
    ...
    def test_future_question(self):
        """
        Вопросы с будущей датой публикации не отображается на странице.
        """
    ...
    def test_past_and_future_questions(self):
        """
        Вопросы с будущей датой публикации не отображается на странице, а с прошлой отображается.
        """
        create_question(question_text='Future question', days=30)
        create_question(question_text='Past question', days=-30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_two_past_questions(self):
        """
        Отображаются оба вопроса с датой публицакии
